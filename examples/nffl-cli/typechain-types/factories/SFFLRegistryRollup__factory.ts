...
import type {
  SFFLRegistryRollup,
  SFFLRegistryRollupInterface,
} from "../SFFLRegistryRollup";
...
const _abi = [
  ...
  {
    type: "function",
    name: "PAUSED_UPDATE_OPERATOR_SET",
    inputs: [],
    outputs: [
      {
        name: "",
  ...
  {
    type: "function",
    name: "forceOperatorSetUpdate",
    inputs: [
      {
        name: "message",
        type: "tuple",
        internalType: "struct OperatorSetUpdate.Message",
        components: [
          {
            name: "id",
            type: "uint64",
          ...
          },
          {
            name: "operators",
            type: "tuple[]",
            internalType: "struct RollupOperators.Operator[]",
            components: [
              {
                name: "pubkey",
                type: "tuple",
    ...
    inputs: [
      {
        name: "message",
        type: "tuple",
        internalType: "struct StateRootUpdate.Message",
        components: [
          {
            name: "rollupId",
            type: "uint32",
          ...
          {
            name: "nearDaTransactionId",
            type: "bytes32",
            internalType: "bytes32",
          },
          {
            name: "nearDaCommitment",
            type: "bytes32",
            internalType: "bytes32",
          },
          {
      ...
      },
      {
        name: "proofParams",
        type: "tuple",
        internalType: "struct SFFLRegistryBase.ProofParams",
        components: [
          {
            name: "target",
            type: "address",
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        name: "signatureInfo",
        type: "tuple",
        internalType: "struct RollupOperators.SignatureInfo",
        components: [
          {
...
type SFFLRegistryRollupConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: SFFLRegistryRollupConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class SFFLRegistryRollup__factory extends ContractFactory {
  constructor(...args: SFFLRegistryRollupConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): SFFLRegistryRollup__factory {
    return super.connect(runner) as SFFLRegistryRollup__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): SFFLRegistryRollupInterface {
    return new Interface(_abi) as SFFLRegistryRollupInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): SFFLRegistryRollup {
    return new Contract(address, _abi, runner) as unknown as SFFLRegistryRollup;
  }
}
