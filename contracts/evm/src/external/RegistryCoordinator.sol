// Original implementation by Layr Labs, Inc.
// Modified to make some methods public and virtual, which is necessary for
// neatly extending them in SFFLRegistryCoordingator.
// This contract should be replaced as soon as possible if those methods are
// similarly changed in the main implementation, which is reasonable enough for
// a library.
    ...
    ISignatureUtils
{
    ...
    modifier quorumExists(uint8 quorumNumber) {
        require(quorumNumber < quorumCount, "RegistryCoordinator.quorumExists: quorum does not exist");
        _;
    }
     ...
     */
    function updateOperators(address[] calldata operators) public virtual onlyWhenNotPaused(PAUSED_UPDATE_OPERATOR) {
        ...
        onlyWhenNotPaused(PAUSED_UPDATE_OPERATOR)
    {
        ...
        require(
            _quorumsAllExist(quorumBitmap), "RegistryCoordinator.updateOperatorsForQuorum: some quorums do not exist"
        );
        require(
     ...
     */
    function ejectOperator(address operator, bytes calldata quorumNumbers) public virtual onlyEjector {
    ...
    function _verifyChurnApproverSignature(
        ...
        EIP1271SignatureUtils.checkSignature_EIP1271(
            ...
            calculateOperatorChurnApprovalDigestHash(
                registeringOperatorId, operatorKickParams, churnApproverSignature.salt, churnApproverSignature.expiry
            ),
    ...
    function calculateOperatorChurnApprovalDigestHash(
        ...
        return _hashTypedDataV4(
            keccak256(
                abi.encode(OPERATOR_CHURN_APPROVAL_TYPEHASH, registeringOperatorId, operatorKickParams, salt, expiry)
            )
        );
    }
