...
func (agg *Aggregator) GetAggregatedCheckpointMessages(fromTimestamp, toTimestamp uint64, reply *messages.CheckpointMessages) error {
	return agg.msgDb.FetchCheckpointMessages(fromTimestamp, toTimestamp, reply)
}
