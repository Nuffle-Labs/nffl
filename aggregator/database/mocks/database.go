...
// Source: github.com/NethermindEth/near-sffl/core/database (interfaces: Databaser)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/database.go -package=mocks github.com/NethermindEth/near-sffl/core/database Databaser
//
...
func (m *MockDatabaser) FetchOperatorSetUpdate(arg0 uint64, arg1 *contractSFFLRegistryRollup.OperatorSetUpdateMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabaser) FetchOperatorSetUpdateAggregation(arg0 uint64, arg1 *types.MessageBlsAggregationServiceResponse) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabaser) FetchStateRootUpdate(arg0 uint32, arg1 uint64, arg2 *contractSFFLServiceManager.StateRootUpdateMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabaser) FetchStateRootUpdateAggregation(arg0 uint32, arg1 uint64, arg2 *types.MessageBlsAggregationServiceResponse) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabaser) StoreOperatorSetUpdate(arg0 contractSFFLRegistryRollup.OperatorSetUpdateMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabaser) StoreOperatorSetUpdateAggregation(arg0 contractSFFLRegistryRollup.OperatorSetUpdateMessage, arg1 types.MessageBlsAggregationServiceResponse) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabaser) StoreStateRootUpdate(arg0 contractSFFLServiceManager.StateRootUpdateMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockDatabaser) StoreStateRootUpdateAggregation(arg0 contractSFFLServiceManager.StateRootUpdateMessage, arg1 types.MessageBlsAggregationServiceResponse) error {
	m.ctrl.T.Helper()
