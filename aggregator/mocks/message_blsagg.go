...
// Source: github.com/Nuffle-Labs/nffl/aggregator/blsagg (interfaces: MessageBlsAggregationService)
//
// Generated by this command:
//
//	mockgen -destination=./mocks/message_blsagg.go -package=mocks github.com/Nuffle-Labs/nffl/aggregator/blsagg MessageBlsAggregationService
//
...
import (
	...
	blsagg "github.com/Nuffle-Labs/nffl/aggregator/blsagg"
...
func (m *MockMessageBlsAggregationService) GetResponseChannel() <-chan blsagg.MessageBlsAggregationServiceResponse {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetResponseChannel")
	ret0, _ := ret[0].(<-chan blsagg.MessageBlsAggregationServiceResponse)
	return ret0
}
...
func (m *MockMessageBlsAggregationService) InitializeMessageIfNotExists(arg0 [32]byte, arg1 []types.QuorumNum, arg2 []types.QuorumThresholdPercentage, arg3, arg4 time.Duration, arg5 uint64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InitializeMessageIfNotExists", arg0, arg1, arg2, arg3, arg4, arg5)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockMessageBlsAggregationServiceMockRecorder) InitializeMessageIfNotExists(arg0, arg1, arg2, arg3, arg4, arg5 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InitializeMessageIfNotExists", reflect.TypeOf((*MockMessageBlsAggregationService)(nil).InitializeMessageIfNotExists), arg0, arg1, arg2, arg3, arg4, arg5)
}

// ProcessNewSignature mocks base method.
func (m *MockMessageBlsAggregationService) ProcessNewSignature(arg0 context.Context, arg1 blsagg.MessageBlsAggregationServiceMessage, arg2 *bls.Signature, arg3 types.Bytes32) error {
	m.ctrl.T.Helper()
